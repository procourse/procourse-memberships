...
module DiscourseLeague
  class Gateways
    class BraintreeGateway < DiscourseLeague::Billing::Gateway
      ...
      def initialize(options = {})
        @configuration = Braintree::Configuration.new(
          ...
          :environment       => (DiscourseLeague::Billing::Gateways.mode || (test? ? :sandbox : :production)).to_sym
        )
      ...
      def verify(credit_card, options = {})
        DiscourseLeague::MultiResponse.run(:use_first_response) do |r|
      ...
      def store(creditcard, options = {})
        if options[:customer].present?
          DiscourseLeague::MultiResponse.new.tap do |r|
      ...
      def update(vault_id, creditcard, options = {})
        ...
        commit do
          ...
          return DiscourseLeague::Response.new(false, 'Braintree::NotFoundError') if braintree_credit_card.nil?
          ...
          DiscourseLeague::Response.new(result.success?, message_from_result(result),
      ...
      def unstore(customer_vault_id, options = {})
        commit do
          ...
          DiscourseLeague::Response.new(true, "OK")
        end
      end
      ...
      def check_customer_exists(customer_vault_id)
        commit do
          begin
            ...
            DiscourseLeague::Response.new(true, "Customer found", {exists: true}, authorization: customer_vault_id)
          rescue Braintree::NotFoundError
            DiscourseLeague::Response.new(true, "Customer not found", {exists: false})
          end
        end
      end
      ...
      def commit(&block)
        ...
        DiscourseLeague::Response.new(false, ex.class.to_s)
      end
      ...
      def create_transaction(transaction_type, money, credit_card_or_vault_id, options)
        ...
        commit do
          ...
          response = DiscourseLeague::Response.new(result.success?, message_from_transaction_result(result), response_params(result), response_options(result))
